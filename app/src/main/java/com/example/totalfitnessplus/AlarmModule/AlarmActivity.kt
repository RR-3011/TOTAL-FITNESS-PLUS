...
import com.example.totalfitnessplus.databinding.ActivityAlarmBinding
import java.util.*
...
class AlarmActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        alarmTimePicker = binding.timePicker as TimePicker
    ...
    fun OnToggleClicked(view: View) {
        ...
        if ((view as ToggleButton).isChecked) {
            Toast.makeText(this, "ALARM SET FOR EXERCISE", Toast.LENGTH_SHORT).show()
            ...
            // BroadcastReceiver
            val intent = Intent(this, AlarmReceiver_AM::class.java)
